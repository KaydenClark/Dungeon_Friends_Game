...
| [S-011](specs/S-011-production-reaction-vocabulary/SPEC.md) | TK-002: Add validated material/effect state to RoomGrid and the LDtk authoring/import path. (ready) | claude-engineer | TK-001 | TK-001 closed with proof. | Complete TK-002. |
<!-- hot-specs:end -->
