...
| [S-008](specs/S-008-reaction-gate-readability/SPEC.md) | TK-001: Add failing readability/cue assertions, then recut fire/smoke marks, encounter-only hints, and blocked/focus feedback without changing reaction results. (in-progress) | codex-engineer | none | TK-001 recut is green in the isolated Engineer worktree; immutable checkpoint review is pending. | Push the verified checkpoint for an exact-head Auditor review before closing TK-001. |
