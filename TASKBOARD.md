...
|---|---|---|---|---|---|
| [S-002](specs/S-002-shared-material-reaction-vocabulary/SPEC.md) | TK-003: Record the owner fun, revise, or stop verdict. (blocked) | Kayden | S-008/TK-001; Kayden played fun/not-fun verdict | Claude's scripted playtest found the system fun but the fire/smoke presentation weak; that evidence does not substitute for Kayden's owner verdict. | Complete S-008/TK-001, then Kayden plays the recut reaction room and records fun, revise, or stop. |
| [S-008](specs/S-008-reaction-gate-readability/SPEC.md) | TK-001: Add failing readability/cue assertions, then recut fire/smoke marks, encounter-only hints, and blocked/focus feedback without changing reaction results. (ready) | unassigned | none | Claude's played pass found the systems fun but fire/smoke, overlapping hints, and focus feedback still undersell them. | Claim TK-001 and add the failing readability assertions before changing the dev room. |
