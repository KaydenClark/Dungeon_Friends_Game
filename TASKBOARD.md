...
| [S-008](specs/S-008-reaction-gate-readability/SPEC.md) | TK-001: Add failing readability/cue assertions, then recut fire/smoke marks, encounter-only hints, and blocked/focus feedback without changing reaction results. (in-progress) | codex-engineer | none | TK-001 audit remediation is green in the isolated Engineer worktree; a new immutable checkpoint review is pending. | Push the remediated checkpoint and run an exact-head Auditor re-review before closing TK-001. |
