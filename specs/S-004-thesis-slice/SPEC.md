...
| TK-003 | Complete the authored loop and capture the under-one-minute thesis demo artifact. | done | TK-002 | green: unit 50 suites/401 tests/2632 checks PASS with 0 script errors; slice smoke 134/134; boot clean; the windowed thesis demo (scenes/dev/thesis_demo.tscn) runs the WHOLE authored loop in the real booted game in under a minute with zero FAILs and seven fail-closed verified captures committed at docs/screenshots/s004-thesis: forest south doorway walk-in, Wren recruited on her own dialogue (toast + three-name HUD + visible third member), Moss's herb bed grown with no combat, the vine gate opened from its trellis, the grove guardian beaten in the in-room encounter driven through the real controller verbs (move/attack/cycle/end-turn), the grove heart regrown on victory, the save round trip proven, and a walk out/in rebuilding the grove fresh with the gate open, guardian gone, and hearts green; grove return doorway now resumes the suspended forest via the room stack (fixes the TK-002 review's stack-leak finding, with a fresh-forest fallback for saves loaded straight into the grove); grove.ldtk gained its Ground art layer after the first capture showed an unreadable void; defensive occupancy unregister added on follower respawn (review finding 2); debug warp keys extended for the sixth room |
...
| 2026-07-20 | TK-003 | Ticket closed | green: unit 50 suites/401 tests/2632 checks PASS with 0 script errors; slice smoke 134/134; boot clean; the windowed thesis demo (scenes/dev/thesis_demo.tscn) runs the WHOLE authored loop in the real booted game in under a minute with zero FAILs and seven fail-closed verified captures committed at docs/screenshots/s004-thesis: forest south doorway walk-in, Wren recruited on her own dialogue (toast + three-name HUD + visible third member), Moss's herb bed grown with no combat, the vine gate opened from its trellis, the grove guardian beaten in the in-room encounter driven through the real controller verbs (move/attack/cycle/end-turn), the grove heart regrown on victory, the save round trip proven, and a walk out/in rebuilding the grove fresh with the gate open, guardian gone, and hearts green; grove return doorway now resumes the suspended forest via the room stack (fixes the TK-002 review's stack-leak finding, with a fresh-forest fallback for saves loaded straight into the grove); grove.ldtk gained its Ground art layer after the first capture showed an unreadable void; defensive occupancy unregister added on follower respawn (review finding 2); debug warp keys extended for the sixth room | RUNBOOK thesis demo + hand-play launch commands; grove return contract documented at GroveRoom._on_doorway | TK-004 is Kayden's batch verdict over the S-004 replay plus the S-009..S-014 deferred owner gates (D-038); authored art/audio for the grove stays placeholder per S-004 non-goals and S-015 gating |
