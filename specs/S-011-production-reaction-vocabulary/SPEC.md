...
| TK-004 | Capture and verify a production same-state exploration/encounter replay. | done | TK-003 | windowed reaction_replay_demo 14/14 PASS with 4 captures docs/screenshots/s011-tk004-reaction-replay: authored materials render, exploration fire burns the vine, water+spark commit inside a live in-room encounter through the same ReactionCaster seam, victory preserves every committed change, and a context-swapped replay on a fresh room lands on the byte-identical material_state (D-031); unit 45 suites/350 tests/2361 checks PASS; slice smoke 134/134 |
...
| 2026-07-20 | TK-004 | Ticket closed | windowed reaction_replay_demo 14/14 PASS with 4 captures docs/screenshots/s011-tk004-reaction-replay: authored materials render, exploration fire burns the vine, water+spark commit inside a live in-room encounter through the same ReactionCaster seam, victory preserves every committed change, and a context-swapped replay on a fresh room lands on the byte-identical material_state (D-031); unit 45 suites/350 tests/2361 checks PASS; slice smoke 134/134 | RUNBOOK replay command; demo header documents the debug overlay stand-in for S-012 VFX | TK-005 owner vocabulary verdict batches at the S-004 thesis replay per D-038; production material VFX owned by S-012/S-004 |
