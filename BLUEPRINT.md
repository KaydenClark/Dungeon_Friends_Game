...
| [S-009 - Unified World Runtime](specs/S-009-unified-world-runtime/SPEC.md) | Replace the split production world/battle spine with one neutral room-state and party/encounter lifecycle without deleting the green v1 fallback early. | active |
